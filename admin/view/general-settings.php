  ...
  <div class="row">
    ...
    <div class="col-sm-3 hidden-xs">
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card p-l-15 p-r-15 p-t-20 p-b-20 text-left m-b-15">
            <h2 class="text-primary text-600 m-t-0 m-b-0 m-b-10"><?=$db->query("SELECT SUM(amount) as num FROM payments WHERE status = '1';")->fetch_assoc()['num']?></h2>
            <div class="text-uppercase text-medium text-500">Bugünlük Kazanç</div>
          </div>
        </div>
      </div>
    </div>
